...
$q="UPDATE `booking` SET `id`='$id',`fname`='$name',`mname`='$mname',
`lname`='$lname',`gender`='$gender',`age`='$age',`mail`='$mail',`number`='$mobile',`nation`='$nation',`state`='$state',`city`='$city',`pin`='$pin',`datejourny`='$dtj',`datereturn`='$dtr',`fcity`='$from',`fto`='$to',`address`='$pr',`nump`='$nop',`payment`='$paym' WHERE  id='$id'";
